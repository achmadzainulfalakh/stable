...
class Pages extends CI_Controller {
	...
	{		
		...
		$this->load->view('backendcontents/pages');
	...
	{		
		...
		if($_POST){
			$post_data = array(
			'post_author'=>$this->input->post('posting_by'),
			'post_type'=>$this->input->post('post_type'),
			'post_title'=>$this->input->post('post_title'),
			'post_content'=>$this->input->post('content'),
			);
			$this->posts_model->set_post($post_data);
			redirect('pages');
		...
		$this->load->view('backendcontents/head', $data);
		$this->load->view('backendcontents/header');
		$this->load->view('backendcontents/page_add');
		$this->load->view('backendcontents/footer');
		$this->load->view('backendcontents/foot');			
	}
	public function Page_edit($id)
	{
		if($_POST){
			...
			$this->posts_model->update_post(decode_url($id),$post_data);
			redirect('pages');
			
		}
		$page=$this->posts_model->get_post_by(array('id'=>decode_url($id)));
		$user=$this->users_model->get_user_by(array('id'=>$this->login_model->user_id()));
		$data = array(
				'title'   => 'Pages',
				'script'=>'',
				// 'settings' => $this->settings,
		...
		$this->load->view('backendcontents/head', $data);
		$this->load->view('backendcontents/header');
		$this->load->view('backendcontents/page_edit');
		$this->load->view('backendcontents/footer');
		$this->load->view('backendcontents/foot');
	}
	public function Page_deleete($id)
	{
		if($_POST){
			$post_data = array(
			'post_author'=>$this->input->post('posting_by'),
