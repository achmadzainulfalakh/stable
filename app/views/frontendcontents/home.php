...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - July 28, 2014!</div>
  <div class="container">
    <div class="row">
      <div class="grid_12">
        <h3>About Us</h3>
        <img src="<?php echo $cdn_url ?>images/page2_img.jpg" alt="" class="img_inner fleft">
  ...
  <div class="container">
    <div class="row" >
      ...
      <div class="grid_2">
        <img src="<?php echo $cdn_url ?>images/page2_img1.jpg" alt="" class="bord_img">
      ...
      <div class="grid_2">
        <img src="<?php echo $cdn_url ?>images/page2_img2.jpg" alt="" class="bord_img">
      ...
      <div class="grid_2">
        <img src="<?php echo $cdn_url ?>images/page2_img3.jpg" alt="" class="bord_img">
      ...
      <div class="grid_2">
        <img src="<?php echo $cdn_url ?>images/page2_img4.jpg" alt="" class="bord_img">
      ...
      <div class="grid_2">
        <img src="<?php echo $cdn_url ?>images/page2_img5.jpg" alt="" class="bord_img">
      ...
      <div class="grid_2">
        <img src="<?php echo $cdn_url ?>images/page2_img6.jpg" alt="" class="bord_img">
