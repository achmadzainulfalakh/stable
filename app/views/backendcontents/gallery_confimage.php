						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<?php echo $imgname ?>
									<button title="Klik untuk Hapus Gambar" id="do_trashimg" class="pull-right"><i class="fa fa-trash-o"></i></button>
									<script>
								...
								<button title="Klik setelah mengubah nama." id="do_renameimg" class="pull-right"><i class="fa fa-edit"></i></button>
									<script>
									$(document).ready(function(){
