            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<a href="#" data-toggle="collapse" data-target="#paneladd" class="btn btn-primary btn-lg"><i class="fa fa-minus "></i> Collapse</a>
						<a href="<?php print base_url().'page/ourclients' ?>" class="btn btn-primary btn-lg"><i class="fa fa-plus "></i> Add New</a>
                        </h1>
						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<?php echo form_open(base_url()."page/ourclients/".$id,$attributes) ?>
								<?php if($post){ ?>
								...
								<?php $attributes = array('role' => 'form'); ?>
								<?php echo form_open(base_url()."page/ourclients/",$attributes) ?>
							...
							<table class="table table-striped">
								...
								<?php foreach($posts as $val){ ?>
								  <tr>
									...
									<a title="Edit" href="<?php echo base_url()."page/ourclients/".encode_url($val->ID) ?>" class=""><i class="fa fa-wrench fa-lg"></i></a>
									
									</td>
									<td><?php print $val->post_title ?></td>
									<td style="max-width: 200px;display: block;overflow: hidden;height: 200px;"><?php print $val->post_content ?></td>
									<td><center><a title="Hapus" href="<?php echo base_url()."page/ourclients/".encode_url($val->ID)."/delete" ?>" class=""><i class="fa fa-trash-o fa-lg"></i></a></center></td>
								  </tr>
								<?php } ?>
								</tbody>
							</table>
